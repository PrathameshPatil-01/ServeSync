    ...
    <>
      ...
      <div className={`sidebar right ${isOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-section">
          ...
          <SidebarItem icon={<User size={18} />} label="Profile settings" onClick={() => {navigate('/profile'); onClose();}} />
          <SidebarItem icon={<Bell size={18} />}label="Notifications"onClick={() => {onUserNotificationIconClick();}}/>

          <SidebarItem icon={<Heart size={18} />}label="My list"onClick={() => {navigate('/my-list');onClose();}}/>
